  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen text-white px-4 hero-section">
      <div className="text-center max-w-4xl animate-fade-in">
        <p className="text-yellow-400 text-sm md:text-base tracking-wider mb-4 animate-fade-in-up">SERIOUS ABOUT BUYING A FIRM?</p>
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-4">
          <span className="bg-gradient-to-r from-yellow-400 to-yellow-600 text-transparent bg-clip-text animate-fade-in-down">Off-Market Access.</span>
          <br />
          <span className="text-white animate-fade-in-up">Simplified.</span>
        </h1>
        <div className="flex justify-center mt-12">
          <button 
            onClick={() => window.scrollTo({ top: window.innerHeight, behavior: 'smooth' })}
            className="group flex flex-col items-center text-white/80 hover:text-white transition-colors animate-fade-in"
          >
