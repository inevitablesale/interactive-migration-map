            ...
            <div className="p-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-gray-500">Rank: {marketData.population_rank}</p>
                </div>
                <div>
                  ...
                  <p className="text-sm text-gray-500">Rank: {marketData.income_rank}</p>
                </div>
              </div>
            </div>
          </Card>
            ...
            <div className="p-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-gray-500">Rank: {marketData.density_rank}</p>
                </div>
                <div>
                  ...
                  <p className="text-sm text-gray-500">Rank: {marketData.growth_rank}</p>
                </div>
              </div>
            </div>
          </Card>
