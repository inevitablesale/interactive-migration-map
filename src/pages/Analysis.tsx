    ...
    <div className="min-h-screen bg-gradient-to-b from-[#1A1F2C] to-[#221F26]">
      ...
      <section className="relative py-20 px-4 bg-black/40 backdrop-blur-sm">
        <div className="max-w-6xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-8 bg-gradient-to-r from-[#9b87f5] to-[#D946EF] bg-clip-text text-transparent animate-gradient">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
            {stats.map((stat) => (
              <div
                key={stat.label}
                className="bg-[#1A1F2C]/60 backdrop-blur-md border border-[#6E59A5]/20 rounded-lg p-6 animate-fade-in hover:border-[#9b87f5]/40 transition-colors"
              >
                ...
                <p className="text-[#8E9196]">{stat.label}</p>
              </div>
            ))}
          </div>
        </div>
